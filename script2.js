...
let agentiData = [
  ...
  { id: 'b.provenzano', text: 'Ispettore Bernardo Provenzano' },
  { id: 'l.serra', text: 'Ispettore Luca Serra' },
  { id: 'd.grillo', text: 'Vice Ispettore Dario Grillo' },
  { id: 'a.capuano', text: 'Sovrintendente Andrea Capuano' },
  { id: 'g.marrone', text: 'Sovrintendente Gennaro Marrone' },
  { id: 'f.manero', text: 'Sovrintendente Felice Manero' },
  { id: 's.vitale', text: 'Assistente Stefano Vitale' },
  ...
  { id: 'j.elrapido', text: 'Agente Jaquin Elrapido' },
  { id: 'o.malaspina', text: 'Agente Ofelia Malaspina'},
  { id: 'j.rasco', text: 'Agente Jeck Rasco'},
  { id: 'b.sabino', text: 'Agente Bartoli Sabino'},
  { id: 'g.mancuso', text: 'Agente Giuseppe Mancuso'},
  { id: 'm.meridio', text: 'Agente Marco Meridio'},
];
